...
def export(var):
    ...
    if hotel_flag:
        ...
        all_rows= get_excel_body_json_format(defaults,attendees,groups,tags,attendee_tags,questions,all_answers,sessions,seminar_users,travels,travel_list,all_bookings,rooms,hotels,locations,req_buddy,match_lines)
...
def get_excel_body_json_format(defaults,attendees,groups,tags,attendee_tags,questions,all_answers,sessions,seminar_users,travels,travel_list,all_bookings,rooms,hotels,locations,req_buddy,match_lines):
    excel_rows=[]
    for attendee in attendees:
        ...
        if 'group' in defaults and defaults['group']:
            each_row.append(get_group_json_format(attendee['fields']['group'],groups))
